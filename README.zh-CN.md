...
**面向 Claude Code 的多智能体编排** —— 你只跟一个 AI 项目经理对话，
...
- 🧑‍💻 **独立开发者** —— 想让多个 AI 工人并行干真实项目，又不想陷入聊天窗口的混乱
...
单纯的 Claude Code 是一个聊天里的一个工人。Lane Stack 加上了一层**管理**：带文件所有权的任务卡、来自不同厂商的并行车道、独立的评审关卡、自动合并到 `main`，以及冷启动恢复。你负责策略，它负责后勤。
