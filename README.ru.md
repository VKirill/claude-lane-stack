...
### Маленький ИИ-завод для одного человека · **v1.13.2**
...
cd claude-lane-stack && git checkout v1.13.2 # или main
./install.sh
...
📖 Гайд: **[docs/BEGINNER.ru.md](docs/BEGINNER.ru.md)** · Релиз: **[v1.13.2](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.13.2)**
...
| 🚀 Релиз v1.13.2 | [GitHub Releases](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.13.2) |
