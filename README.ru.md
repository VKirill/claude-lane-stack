...
### Маленький ИИ-завод для одного человека · **v1.12.8**
...
cd claude-lane-stack && git checkout v1.12.8 # или main
./install.sh
...
📖 Гайд: **[docs/BEGINNER.ru.md](docs/BEGINNER.ru.md)** · Релиз: **[v1.12.8](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.12.8)**
...
| 🚀 Релиз v1.12.8 | [GitHub Releases](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.12.8) |
