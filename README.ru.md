...
### Маленький ИИ-завод для одного человека · **v1.14.11**
...
cd claude-lane-stack && git checkout v1.14.11 # или main
./install.sh
...
📖 Гайд: **[docs/BEGINNER.ru.md](docs/BEGINNER.ru.md)** · Релиз: **[v1.14.11](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.14.11)**
...
| 🚀 Релиз v1.14.11 | [GitHub Releases](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.14.11) |
