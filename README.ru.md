...
### Маленький ИИ-завод для одного человека · **v1.5.1**
...
cd claude-lane-stack && git checkout v1.5.1 # или main
./install.sh
...
📖 Гайд: **[docs/BEGINNER.ru.md](docs/BEGINNER.ru.md)** · Релиз: **[v1.5.1](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.5.1)**
...
| 🚀 Релиз v1.5.1 | [GitHub Releases](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.5.1) |
