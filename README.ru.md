...
### Маленький ИИ-завод для одного человека · **v1.14.12**
...
cd claude-lane-stack && git checkout v1.14.12 # или main
./install.sh
...
📖 Гайд: **[docs/BEGINNER.ru.md](docs/BEGINNER.ru.md)** · Релиз: **[v1.14.12](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.14.12)**
...
| 🚀 Релиз v1.14.12 | [GitHub Releases](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.14.12) |
