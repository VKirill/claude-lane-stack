...
### Маленький ИИ-завод для одного человека · **v1.12.9**
...
cd claude-lane-stack && git checkout v1.12.9 # или main
./install.sh
...
📖 Гайд: **[docs/BEGINNER.ru.md](docs/BEGINNER.ru.md)** · Релиз: **[v1.12.9](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.12.9)**
...
| 🚀 Релиз v1.12.9 | [GitHub Releases](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.12.9) |
