...
**Мульти-агентная оркестрация для Claude Code** — вы говорите с одним ИИ-менеджером,
...
- 🧑‍💻 **Соло-разработчики**, которым нужны параллельные ИИ-воркеры без хаоса чатов
...
Первый раз в проекте, внутри чата: **`/project-onboard`** — создаёт «паспорт» репозитория (`CLAUDE.md`, стартовые доки).
