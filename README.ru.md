...
### Маленький ИИ-завод для одного человека · **v1.4.0**
...
cd claude-lane-stack && git checkout v1.4.0 # или main
./install.sh
...
📖 Гайд: **[docs/BEGINNER.ru.md](docs/BEGINNER.ru.md)** · Релиз: **[v1.4.0](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.4.0)**
...
| 🚀 Релиз v1.4.0 | [GitHub Releases](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.4.0) |
