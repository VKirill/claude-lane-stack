...
echo "Manual lane recovery: lane-supervisor (Qwen, AGY, or Grok writer)"
echo "Pools: provider default 5/max 10; verification default 2/max 10"
echo "Warm lanes: lane-session resumes run-scoped Qwen, AGY, or Grok conversations"
echo "Night shift: night-shift-all (Codex Sol xhigh review; selectable Qwen/AGY/Grok repair with typed Sol fallback)"
