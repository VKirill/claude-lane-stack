...
description: "Project onboard via Codex. Scenario minimal|full + depth minimal|deep. Effort medium/high (no default xhigh). CLAUDE.md, docs pack, memory. Not features."
model: sonnet
