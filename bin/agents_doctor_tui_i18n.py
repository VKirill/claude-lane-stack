...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "stage_browser_qa": "Browser QA",
        "stage_browser_qa_badge": "LIVE",
        ...
        "sfield_since": "Since",
        "sfield_hour": "Hour",
        "sfield_backend": "Backend",
        "sfield_approve": "Approve",
        ...
        "when_always": "always",
        "backend_live-chrome": "live Chrome",
        "backend_chrome-qa": "chrome-qa profile",
    ...
    "ru": {
        ...
        "when_always": "всегда",
        "backend_live-chrome": "живой Chrome",
        "backend_chrome-qa": "профиль chrome-qa",
        "backend_headless": "headless",
        "approve_auto": "авто",
        "approve_never": "никогда",
