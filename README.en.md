...
<p>
  <a href="https://github.com/VKirill/claude-lane-stack/releases/tag/v1.59.0"><img src="https://img.shields.io/badge/version-v1.59.0-orange?style=for-the-badge" alt="version" /></a>
...
cd claude-lane-stack && git checkout v1.59.0   # or: main
./install.sh
