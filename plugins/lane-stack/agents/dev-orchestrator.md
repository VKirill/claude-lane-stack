...
tools: Agent(lane-stack:run-supervisor, lane-stack:lane-supervisor, lane-stack:emergency-writer, lane-stack:night-reviewer, lane-stack:project-onboarder, lane-stack:docs-maintainer, lane-stack:design-lead, lane-stack:seo-specialist, lane-stack:copy-lead, lane-stack:tavily, lane-stack:browser-qa, Explore, Plan, general-purpose), Read, Write, Edit, Bash, Grep, Glob, WebFetch, WebSearch, TaskStop, SendMessage, ListAgents, mcp__agentmemory__memory_recall, mcp__agentmemory__memory_smart_search, mcp__agentmemory__memory_profile, mcp__agentmemory__memory_sessions, mcp__agentmemory__memory_remember, mcp__gitnexus__query, mcp__gitnexus__context, mcp__gitnexus__impact, mcp__gitnexus__detect_changes, mcp__gitnexus__list_repos, mcp__metamcp__mcp_discover, mcp__metamcp__mcp_call, mcp__metamcp__mcp_execute, mcp__metamcp__mcp_provision
