...
### A small AI coding factory for one person · **v1.12.6**
...
[![Release](https://img.shields.io/github/v/release/VKirill/claude-lane-stack?color=orange&label=Release)](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.12.6)
...
cd claude-lane-stack && git checkout v1.12.6 # or: main
./install.sh
...
📖 Walkthrough: **[docs/BEGINNER.md](docs/BEGINNER.md)** · Release notes: **[v1.12.6](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.12.6)**
...
| 🚀 Release v1.12.6 | [GitHub Releases](https://github.com/VKirill/claude-lane-stack/releases/tag/v1.12.6) |
